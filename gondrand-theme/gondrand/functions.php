...
function gondrand_purge_button() {
    ...
    echo '<span class="description">À cliquer après une modification si le téléphone n’affiche pas le changement (automatique depuis v2.2.24, bouton de secours).</span></p>';
}
...
function gondrand_try_serve() {
    ...
    if ($ext === 'html') {
        header('X-Gondrand-Theme: 2.2.24');
