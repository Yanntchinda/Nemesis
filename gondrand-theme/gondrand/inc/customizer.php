...
add_action('customize_register', function ($wp_customize) {
    ...
    $wp_customize->add_panel('gondrand_panel', [
        ...
        'description' => 'Préférez le menu Travex (wp-admin) pour modifier toutes les pages. Ici : logo, CSS, e-mail des demandes de cotation.',
        'priority'    => 10,
    ]);

    $wp_customize->add_section('gondrand', [
        'title' => 'Demande de cotation / e-mail',
    ...
    $wp_customize->add_control('gondrand_quote_email', [
        'label'   => 'E-mail des demandes de cotation',
        'section' => 'gondrand',
        'type'    => 'email',
    ]);
    ...
    foreach ([
        ...
        'quote_title' => 'Titre formulaire demande de cotation',
