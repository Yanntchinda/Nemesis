...
function gondrand_pages_admin() {
    ...
    echo '</tbody></table>';
    echo '<p style="margin-top:12px"><label>Nom dans le menu (lien Demande de cotation)&nbsp; <input class="regular-text" name="nav_quote_name" value="' . esc_attr(gondrand_t('nav_quote', 'Demande de cotation')) . '"></label></p>';
